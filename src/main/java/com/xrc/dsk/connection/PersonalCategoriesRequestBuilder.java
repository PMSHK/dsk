...
import static com.xrc.dsk.settings.ApiEndpoints.ROOM_CATEGORIES;

@Slf4j
public class PersonalCategoriesRequestBuilder extends RequestHandler<List<String>, String> {
    private final String url;

    public PersonalCategoriesRequestBuilder(String method) {
        super(method);
        this.url = ROOM_CATEGORIES;
    }
